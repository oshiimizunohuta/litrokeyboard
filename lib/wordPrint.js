...
//	}
	...
	function getSpriteArray(str, color, bgColor)
	{
		this.parse(str);
	...
	wordPrint.prototype.getSpriteArray = getSpriteArray
	;
	...
	wordPrint.prototype.indexOf = indexOf;
...
//				lineWords = new Array;
	...
	function setMarkAlign(align)
	{
		this.soundMarkAlign = align;
	}
	wordPrint.prototype.setMarkAlign = setMarkAlign;
